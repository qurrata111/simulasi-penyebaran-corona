...
namespace SimulasiCovid19
{
    ...
    public class Info
    {
        ...
        public Info(int hari, string file_keterhubungan, string file_populasi)
        {
            init_daerah = getInfoDaerah(file_keterhubungan, file_populasi);
            infected_daerah = findInfectedDaerah(hari, file_keterhubungan, file_populasi);
